...
<html>
	...
	<body>
		...
		<div class="container login-wrapper">
			<form action="auth/login_test.php" method="POST">
				<div class="row">
					...
					<div class="col-md-5 col-md-offset-1">
						<label>驗證碼</label>
						<label>請輸入下圖字樣：</label><p><img id="imgcode" src="./captcha.php" onclick="refresh_code()" /><br />
						點擊圖片可以更換驗證碼
						</p>
						<input type="text" name="checkword" class="form-control">
					</div>
					<br><div class="col-md-12 col-md-offset-2">
						<tr><tr>
